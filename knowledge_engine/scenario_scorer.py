...
# User-facing names for the scenario-grid columns — the "top contributors / top
# detractors" display. Lives in the engine (alongside DRIVER_BUCKETS) so both the
# UI (interface/structure_eval.py) and the agent pack (agentic/render.py) share
# one vocabulary instead of maintaining separate label dicts.
...
def top_bottom_cells(
    ...
    the "top contributors" / "top detractors" display in the UI and the agent pack."""
